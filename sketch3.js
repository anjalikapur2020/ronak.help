...
function setup() {
    ...
    /*levelblock=createSprite(width-130,50)
    levelblock.addImage(levelblockimg)
    levelblock.scale=0.4
    levelblock.visible=false
  ...
  /*  back = createImg("back.png")
    ...
    */
    ...
    /* goldengamekey = createSprite(width / 2+85, height / 1.5)
     goldengamekey.addImage("gold",goldenkey)
     goldengamekey.visible = false*/
